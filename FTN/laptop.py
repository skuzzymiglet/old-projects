...
number_font = pygame.font.Font('fonts/3Dumb.ttf', 32)
large_number_font = pygame.font.Font('fonts/3Dumb.ttf', 64)
score_font = pygame.font.Font('fonts/3Dumb.ttf', 32)
...
def draw_random_square():
    pos_and_size = (random.randint(0, W), random.randint(0, H),
...
def main():
    ...
    score = 15
    on_streak = False
    wait = 1.5 # The time the number is shown
    number_to_key = {
        0: pygame.K_0,
        1: pygame.K_1,
        2: pygame.K_2,
